...
def mix_generations(parents):
    ...
    while 0 < len(parents_copy):
        ...
        childs.append(pair_parents[0][0] + pair_parents[1][1]+ pair_parents[0][2] + pair_parents[1][3])
        childs.append(pair_parents[1][0] + pair_parents[0][1] + pair_parents[1][2] + pair_parents[0][3])
