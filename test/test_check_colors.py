...
@pytest.mark.parametrize(
    ...
    [
        (["Red", "Red", "Red", "Red"],["Red", "Green", "Blue", "Red"], 6),
        (["Red", "Green", "Blue", "Red"],["Red", "Green", "Blue", "Red"], 8),
        (["Red", "Red", "Red", "Red"],["Green", "Blue", "Yellow", "Pink"], 0),
        (["Pink", "Yellow", "Blue", "Green"],["Green", "Blue", "Yellow", "Pink"], 4)
    ]
)
